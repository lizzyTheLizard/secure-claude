...
describe('buildSystemPrompt', () => {
  ...
  it('mentions deny-all policy when defaultAllow is false', async () => {
    await recreateTmpDir(baseConfig({ defaultAllow: false }))
